...
class UserManager(BaseUserManager):
    ...
    def _create_user(self, username, password, email, is_staff, is_active,
                     *args, **extra_fields):
        """
    ...
    def create_user(self, username, password, email=None, **extra_fields):
        return self._create_user(username, password, email, False, False,
                                 **extra_fields)
    ...
    def create_superuser(self, username, password, email=None, **extra_fields):
        ...
        return self._create_user(username, password, email, True, True,
                                 **extra_fields)
...
class User(Base, AbstractBaseUser, PermissionsMixin):
    ...
    last_certificate = models.CharField(_('last certificate'),
                                        null=True,
                                        max_length=300)
    address = models.TextField(_('Address'), null=True, blank=True)
    mobile_number = models.CharField(_('cell phone'),
                                     max_length=20,
                                     null=True,
                                     blank=True)
